                          ...
                          <form @submit.prevent="handleResetPassword">
                            <v-row align="center" justify="center">
                              <v-col cols="12" sm="8" class="mt-4" >
                                ...
                                <v-text-field v-model="formData.email" label="Email" outlined dense color="blue" autocomplete="false" disabled required/>
                                <v-text-field type="password" label="New Password" v-model="formData.password" outlined dense color="blue" autocomplete="false" required/>
                                <v-text-field type="password" label="Repeat New Password" v-model="formData.password_confirmation" outlined dense color="blue" autocomplete="false" required/>

                                <v-btn color="warning" type="submit" dark block tile :loading="authStore.loading">Submit</v-btn>
