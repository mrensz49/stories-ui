                        ...
                        <v-row align="center" justify="center">
                          <v-col cols="12" md="10" sm="8">
                            ...
                            <form @submit.prevent="handleLogin">
                              ...
                              <v-row>
                                <v-col cols="12" lg="12" md="12" sm="12" class="text-body-2 mt-n9">
                                  <table width="100%">
                                    <tr>
                                      <td>
                                        <v-checkbox color="blue" >
                                          <template v-slot:label>
                                            <small style="font-size: 10.2px;"><b>Remember Me</b></small>
                                          </template>
                                        </v-checkbox>                                        
                                      </td>
                                      <td>
                                        <a href="#" class="text-decoration-none text-right" @click="step+=2" >
                                          <span class="caption blue--text"><small>Forgot password</small></span>
                                        </a>                                        
                                      </td>
                                    </tr>
                                  </table>
                            ...
                            <div class="justify-space-between align-center mb-16">
                              ...
                              <div>
                                ...
                                <div class="mt-5 text-justify">
                                  <small >
                                    By clicking Log In, you agree to our <u class="pointer" @click="consent('terms')">Terms</u>. 
                                    
                                    Learn how we process your data in our <u class="pointer" @click="consent('privacy')">Privacy Policy</u>.
                                  </small>
                                </div>
                            </div>
                          </v-col>
                          ...
                          <v-row align="center" justify="center">
                            ...
                            <v-text-field v-model="formData.password_confirmation" label="Confirm" outlined dense color="blue" autocomplete="false" type="password" required/>
                              ...
                              <v-alert class="mt-8" color="warning" icon="$error" text="" v-if="Object.keys(authStore.errors_reg).length">
                                ...
                                <div class="mt-5 text-justify">
                                  <small >
                                    By clicking Sign Up, you agree to our <u class="pointer" @click="consent('terms')">Terms</u>. 
                    ...
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        <p class="text-center grey--text mt-3 text-justify">
                          No problem. Just let us know your email address and we will email you a password reset linkthat will allow you to choose a new one.
                        </p>
    ...
    methods: {
      ...
      consent(name) {
        if (name == 'terms') {
          ...
          window.location.href = 'https://www.storiesforyou.net/be/privacy-policy'
        }
      }
