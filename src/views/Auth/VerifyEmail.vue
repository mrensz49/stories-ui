                ...
                <v-card-text>
                  ...
                  >
                    <v-progress-circular
                      ...
                      indeterminate
                    ></v-progress-circular>
                    <span class="ml-3 text-h6 font-weight-bold primary--text"
                      >Please wait while verifying your email.</span
                    >
                  </div>
                  <v-alert v-if="authStore.verified" dense text type="success">
                    Successfully verified! Redirecting to dashboard.
                  </v-alert>

                  <v-alert
                    v-if="authStore.errors_verify"
                    dense
                    text
                    type="warning"
                  >
