      ...
      <v-col cols="12" lg="8" xl="8">
        ...
        <div v-if="!this.$route.query.q">
          <div>
                ...
                <v-row class="flex-column">
                  <v-col cols="12" lg="8" md="10" xl="7">
                    <h2 class="text-h3 py-3" style="line-height: 1.2">
                      Reading is a journey, and every story is a new
                      destination.
                    </h2>
                  </v-col>
                </v-row>
            ...
            <div class="py-4">
              <v-btn color="accent">{{
                categoryStore.category.category.category
              }}</v-btn>
            </div>

            <v-row
              v-for="cat in categoryStore.category.contents.data"
              :key="cat.id"
              class="py-2"
            >
              <v-col cols="12" md="3">
                <v-card
                  ...
                  :to="
                    '/category/' +
                    categoryStore.category.category.slug +
                    '?q=' +
                    cat.title_slug
                  "
                >
              ...
              <v-col>
                <a
                  ...
                  "
                >
                  <h3 class="text-h6 text--secondary font-weight-bold">
                    <!-- pt-3 -->
                    {{ cat.title }}
                  </h3>
                </a>
            ...
            <v-row justify="space-between">
              <v-col cols="6" md="6" lg="6" sm="6">
                <a
                  class="align-center"
                  @click="
                    categoryStore.getNewPage({
                      name: categoryStore.category.category.slug,
                      page:
                        parseInt(categoryStore.category.contents.current_page) -
                        1,
                    })
                  "
              ...
              <v-col cols="6" md="6" lg="6" sm="6">
                <div
                  ...
                  v-if="
                    categoryStore.category.contents.current_page !=
                    categoryStore.category.contents.last_page
                  "
                >
                  <a
