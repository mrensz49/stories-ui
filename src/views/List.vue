    ...
    <div>
      ...
      <v-row>
        <v-col cols="12" lg="8" xl="8">
          <div>
            <div>
              <h2 class="text-h4 font-weight-bold text-capitalize">{{ type }} Stories</h2>
                    ...
                    <div>
                      ...
                      <div class="text-body-2 pt-2 text--secondary">
                        <span v-show="type=='visited'">
                            Viewed at <span>&#8226;</span> {{ getHumanDateDay(list.last_viewed_at) }}
                        </span>
                        <span v-show="type=='unvisited' || type=='latest'">
                            Released at <span>&#8226;</span> {{ getHumanDateDay(list.date_release) }}
                        </span>
                      </div>
                    </div>
                  </v-col>
                ...
                <v-row justify="space-between" class="mb-2">
                    <v-col cols="6" md="6" lg="6" sm="6">
                      <a class="align-center"
                        ...
                        @click="loadStories(parseInt(authStore.list_stories.current_page) - 1)"
                      >
                    ...
                    <v-col cols="6" md="6" lg="6" sm="6">
                    <div class="align-center text-right" v-if="authStore.list_stories.current_page != authStore.list_stories.last_page">
