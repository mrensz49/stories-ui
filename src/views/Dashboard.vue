                ...
                >
                  <div>
                    <v-card
                      ...
                      :to="'/list/visited'"
                      :disabled="
                        authStore.user?.email_verified_at ? false : true
                      "
                    >
                      <v-img
                  ...
                  <div>
                    ...
                    >
                      ...
                      <v-card-text>
                        <div class="text-h5 font-weight-bold primary--text">
                          {{
                            authStore.count_unread_stories > 15
                              ? "15+"
                              : authStore.count_unread_stories
                          }}
                          unvisited stories
                        </div>
                      </v-card-text>
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      <v-card-text>
                        <div class="text-h5 font-weight-bold primary--text">
                          {{ authStore.count_upcoming_stories }} upcoming
                          stories
                        </div>
                      </v-card-text>
                    </v-card>
...
export default {
  ...
  components: {
    ...
    ResendVerificationEmail: () =>
      import("@/components/cards/ResendVerificationEmail"),
  },
};
</script>
